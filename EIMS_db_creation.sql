...
INSERT INTO address VALUES ('A010', '4408 Hauk Drive',              'Cincinnati',    'Ohio',        '97445','United States');
...
INSERT INTO  Transactions VALUES ('T011','C001', 150, '2/3/2022',   '3/3/2022',   'SR01', 'S001');
INSERT INTO  Transactions VALUES ('T012','C002', 100, '3/4/2022',   '4/4/2022',   'SR03', 'S002');
INSERT INTO  Transactions VALUES ('T013','C003', 400, '4/10/2022',  '5/10/2022',  'SR02', 'S003');
INSERT INTO  Transactions VALUES ('T014','C004', 10,  '10/20/2022', '11/20/2022',  'SR04', 'S004');
INSERT INTO  Transactions VALUES ('T015','C005', 50,  '11/19/2022', '12/19/2022',  'SR01', 'S005');
INSERT INTO  Transactions VALUES ('T016','C006', 30,  '10/17/2022', '11/17/2022',  'SR03', 'S006');
INSERT INTO  Transactions VALUES ('T017','C007', 50,  '3/12/2022',  '4/12/2022',   'SR04', 'S007');
INSERT INTO  Transactions VALUES ('T018','C008', 100, '7/5/2022',   '8/5/2022',   'SR05', 'S008');
INSERT INTO  Transactions VALUES ('T019','C009', 50,  '10/7/2022',  '11/7/2022',   'SR02', 'S009');
INSERT INTO  Transactions VALUES ('T020','C010', 35,  '4/9/2022',   '5/9/2022',    'SR04', 'S010');
...
/* Views used to create our ten Business Questions*/
...
as (
    ...
    dense_rank() over(PARTITION by customer_id order by t.order_amount desc) rnk
    from
    transactions t
...
as (
    ...
    dense_rank() over(PARTITION by customer_id order by t.order_amount asc) rnk
    from
    transactions t
    join customer c on t.customer_id =c.customer_id
        ) x
